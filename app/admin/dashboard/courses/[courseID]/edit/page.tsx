...
// Имитация данных, полученных из базы по courseID
const MOCK_COURSE = {
    id: '1',
    ...
    thumbnailUrl: 'https://placehold.co/800x450/eff6ff/1d4ed8?text=1C+Course+Thumbnail', // Ссылка на текущую обложку
    isPublished: true,
};
...
export default function EditCoursePage() {
    ...
    // Инициализируем стейт моковыми данными (в реальности здесь будет fetch запрос в useEffect)
    ...
    const handleSave = async () => {
        ...
        setIsSaving(true);
        // Эмуляция PUT/PATCH запроса на сервер для обновления курса
        setTimeout(() => {
            setIsSaving(false);
    ...
    return (
        <div className="p-8 lg:p-10 space-y-6 max-w-[1600px] mx-auto w-full font-sans animate-in fade-in duration-300">
            ...
            <section className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-slate-200 pb-6 sticky top-0 bg-slate-50 z-10 pt-4 -mt-4">
                <div>
                    <h1 className="text-3xl font-bold text-slate-900 tracking-tight">Редактирование курса</h1>
                    <p className="text-slate-500 font-medium mt-1">Изменение информации об учебной программе.</p>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                {/* Правая колонка - Настройки и Обложка */}
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 space-y-6">
                        ...
                        {previewImage ? (
                            <div className="relative w-full aspect-video rounded-xl overflow-hidden border border-slate-200 group bg-slate-50">
                                ...
                                <img src={previewImage} alt="Обложка курса" className="w-full h-full object-cover" />
