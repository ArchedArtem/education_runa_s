        ...
        <div className={styles.pageWrapper}>
            ...
            <main className={styles.contentContainer}>
                <section className={styles.heroSection}>
                    <h1 className="text-6xl md:text-7xl font-bold tracking-tight mb-4 text-slate-900">
                        Контакты
                    </h1>
                ...
                <div className={styles.addressCardLarge}>
                    <div className={styles.addressInfo}>
                        ...
                        <h3 className="text-lg font-bold mb-3 text-slate-900">Адрес</h3>
                ...
                <div className={styles.bentoGrid}>
                    <div className={styles.glassCard}>
                        ...
                        <h3 className="text-lg font-bold mb-3 text-slate-900">E-mail</h3>
                    ...
                    <div className={styles.glassCard}>
                        ...
                        <h3 className="text-lg font-bold mb-3 text-slate-900">Время работы</h3>
                        <p className="text-slate-600 leading-relaxed">
